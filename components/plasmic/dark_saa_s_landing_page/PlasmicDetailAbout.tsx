...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: x2kLbhtjM-Q_yH/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__iV1Kg)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column___0Daa)}>
            <h5
